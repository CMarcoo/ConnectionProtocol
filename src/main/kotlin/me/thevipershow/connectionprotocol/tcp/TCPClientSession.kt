...
import me.thevipershow.connectionprotocol.Client
import me.thevipershow.connectionprotocol.ProxyInfo
            ...
            try {
                ...
                val channelInitializer = object : ChannelInitializer<Channel>() {
                    ...
                    override fun initChannel(channel: Channel) {
                        ...
                        pipeline.addLast("encryption",
                            TCPPacketEncryptor(this@TCPClientSession)
                        )
                        pipeline.addLast("sizer",
                            TCPPacketSizer(this@TCPClientSession)
                        )
                        pipeline.addLast("codec",
                            TCPPacketCodec(this@TCPClientSession)
                        )
